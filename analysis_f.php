              ...
              <div class="box box-primary">
				...
				<form name="form1" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" >
                  ...
                  <div class="box-footer">
                    <input type="submit" class="btn btn-primary" name="count_total" value = "Count Faculty Interaction Activities"></input>
				   ...
				   <?php 
						...
						if(isset($_POST['count_total']))
						{
								...
								if (!empty($_POST['min_date']) && !empty($_POST['max_date']))
								{
										...
										{
											$_SESSION['durationf'] = $_POST['min_date'];
											$_SESSION['durationt'] = $_POST['max_date'];
										
										
											$from_date =  $_SESSION['durationf'] ;
											$to_date = $_SESSION['durationt'] ;
							...
							/*$_SESSION['type'] = $_POST['type'];*/
								if($res1 = mysqli_query($conn,$sql1)){
									...
									<tr> 
												...
												<td><strong>Total <?php echo "Count For Faculty Interaction "." "; ?><br>Count is :<?php echo " ".$count; ?></strong></td>
