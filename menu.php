						  ...
						  {?>
							  <li class="" style="list-style: none; font-size: 14px;">
									  ...
									  <ul class="" style="list-style: none;">
										...
										<li><a href="view_invited_hod_lec.php"><i class="fa fa-circle-o"></i>View/Edit Activity</a></li>
										<li><a href="analysis_f_h_i.php"><i class="fa fa-circle-o"></i>Analysis</a></li>
									  </ul>
									</li>
						<?php   }
						  else
