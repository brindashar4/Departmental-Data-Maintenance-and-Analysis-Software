...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update invitedlec set invitation_path ='NULL'  where invited_id = $cardId";
		...
		{
			$query = "Update invitedlec set invitation_path ='not_applicable'  where invited_id = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
		...
		else if($_POST['applicable'] == 1)
		{
			if(isset($_FILES['image']))
			{
			  ...
			  $targetName="invitation_letter/".$_POST['id'].".".$fileExt;  
			  ...
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update invitedlec set invitation_path =' ".$targetName."'  where invited_id = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload Invitation Letter *</h3>
                ...
                <form action="" method="POST" enctype="multipart/form-data" class="row">
					...
					<div class='second-reveal'>
					 <div class="form-group col-md-6">
                         ...
                         <label for="card-image">Invitation Letter  * </label>
