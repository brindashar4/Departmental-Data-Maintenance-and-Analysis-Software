      ...
      <ul class="sidebar-menu">
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
				...
				<li class="2"><a href="orglec.php"><i class="fa fa-circle-o"></i>Guest Lecture Organised</a></li>
				
				<li class="4"><a href="view_organised_lec.php"><i class="fa fa-circle-o"></i>View/Edit Orgainsed</a></li>

				<li class="5"><a href="analysis_i.php"><i class="fa fa-circle-o"></i>Analysis</a></li>
				<li class="6"><a href="guest_chart.php"><i class="fa fa-circle-o"></i>Charts</a></li>
			...
			<li class="treeview">
              ...
              <ul class="treeview-menu">
				 ...
				 <li class="4"><a href='IV.php?x=IV/IV_chart.php'><i class="fa fa-circle-o"></i>Charts</a></li>
             </ul>
            </li>
             <li class="treeview">
              <a href="#">
           ...
           <li class="treeview">
              ...
              <ul class="treeview-menu">
				<li><a href="guestlec.php"><i class="fa fa-circle-o"></i>Activity Form</a></li>
