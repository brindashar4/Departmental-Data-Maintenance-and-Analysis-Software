...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update organised set Brochure_path ='NULL'  where A_ID = $cardId";
		...
		{
			$query = "Update organised set Brochure_path ='not_applicable'  where A_ID = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
		...
		else if($_POST['applicable'] == 1)
		{
			if(isset($_FILES['image']))
			{
			  ...
			  $targetName="brochures/".$_POST['id'].".".$fileExt;  
			  ...
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update organised set Brochure_path =' ".$targetName."'  where A_ID = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload Brochure</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
...
if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
{ ?>
        <a href="2_dashboard_organised_hod.php" type="button" class="btn btn-warning btn-lg">Cancel</a>
<?php
}
else
{
?>
      <a href="2_dashboard_organised.php" type="button" class="btn btn-warning btn-lg">Cancel</a>
<?php
}
?>			 
