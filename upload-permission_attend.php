...
if(isset($_POST['insert-image'])){
	...
	if(isset($_POST['applicable']))
	{
		...
		{
			$query = "Update attended set Permission_path ='NULL'  where A_ID = $cardId";
		...
		{
			$query = "Update attended set Permission_path ='not_applicable'  where A_ID = $cardId";
             mysqli_query($conn,$query);
			 			 $success =1;
		...
		else if($_POST['applicable'] == 1)
		{
			if(isset($_FILES['image']))
			{
			  ...
			  $targetName="permissions/".$_POST['id'].".".$fileExt;  
			  ...
			  if(empty($errors)==true) {
				if (file_exists($targetName)) {   
				 ...
				 if($moved == true){
					 //successful
					 $query = "Update attended set Permission_path =' ".$targetName."'  where A_ID = $cardId";
					 mysqli_query($conn,$query);
					 			 $success =1;
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Upload Permission</h3>
                </div><!-- /.box-header -->
                <!-- form start -->
                <form action="" method="POST" enctype="multipart/form-data" class="row">
					...
					<div class='second-reveal'>
					 <div class="form-group col-md-6">
                         ...
                         <label for="card-image">Permission * </label>
...
if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
{ ?>
        <a href="2_dashboard_attend_hod.php" type="button" class="btn btn-warning btn-lg">Cancel</a>
<?php
}
else
{
?>
      <a href="2_dashboard_attend.php" type="button" class="btn btn-warning btn-lg">Cancel</a>
<?php
}
?>			 
