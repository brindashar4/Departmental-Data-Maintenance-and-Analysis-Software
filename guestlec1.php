            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">Redirection to Guest Lecture Form</h3>
				...
				<a href="menu.php?menu=4 "> <u>Back to Invited for/Organised Guest Lecture Menu</u></a>
				  ...
				  $username = $_SESSION['username'];
					...
					if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
					{
						header("location:guest2_hod.php?alert=success");
					...
					if(isset($_POST['cancel']))
					  {
						  if($username == 'hodextc@somaiya.edu' || 'member@somaiya.edu' || 'hodcomp@somaiya.edu')
						{
