...
if($_SESSION['username'] == ('hodextc@somaiya.edu') || $_SESSION['username'] == ('member@somaiya.edu') || $_SESSION['username'] == ('hodcomp@somaiya.edu') )
  {
		...
		$query1 = "SELECT MAX(durationf) from guestlec";
...
while($startYear != $endYear) {
	...
	$query = "SELECT COUNT(*) FROM guestlec WHERE durationf >= '$date1' AND durationt <= '$date2'";
  ...
  else
  {
	  ...
	  $query1 = "SELECT MAX(durationf) from guestlec WHERE Fac_ID ='".$_SESSION['Fac_ID']."'; ";
$result1 = mysqli_query($conn,$query1);
while($row =mysqli_fetch_assoc($result1)){
    $maxEndDate = $row['MAX(durationf)'];
}
...
while($startYear != $endYear) {
	...
	$date1 = $startYear.'-07-01';
	$date2 = $temp_year.'-06-30';
	$query = "SELECT COUNT(*) FROM guestlec WHERE durationf >= '$date1' AND durationt <= '$date2' AND Fac_ID = $fid ";
	$result = mysqli_query($conn,$query);
	while($row = mysqli_fetch_assoc($result)){
    	$temp_count = $row['COUNT(*)'];
    	array_push($year, $startYear.'-'.substr($temp_year,2,4));
        ...
        <section class="content">
          <div class="row">
			...
			<div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">No. of Invited lectures</h3>
            ...
            <div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">No. Of Organized Lectures</h3>
                  <div class="box-tools pull-right">
                    <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                    <button class="btn btn-box-tool" data-widget="remove"><i class="fa fa-times"></i></button>
                  </div>
