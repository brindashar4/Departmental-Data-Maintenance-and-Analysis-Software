...
$query1 = "SELECT MAX(t_from) from iv_attended WHERE f_id ='".$_SESSION['Fac_ID']."'; ";
...
while($startYear != $endYear) {
	...
	$query = "SELECT COUNT(*) FROM iv_attended WHERE t_from >= '$date1' AND t_to <= '$date2' AND f_id = $fid ";
			...
			<div class="col-md-6">
              ...
              <div class="box box-primary">
                <div class="box-header with-border">
                  <h3 class="box-title">No. of Attended lectures</h3>
