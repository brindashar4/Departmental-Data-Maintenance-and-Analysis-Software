			...
			?>			  
              ...
              <?php }?>    
                   ...
                   <?php
					...
					if($_SESSION['username'] == 'hodextc@somaiya.edu' || $_SESSION['username'] == 'hodcomp@somaiya.edu' )
					{
                                   echo"     <button name ='upload' type = 'submit' class = 'btn btn-primary btn-sm'>
                ...
                <div class="row">
                  ...
                  <div class="col-md-2">
                    <?php 
                     ...
                     ?>
                    <a href="IV/export_to_excel.php" type="button" class="btn btn-primary"><span class="glyphicon ">Export</span></a>
